...
import {CAFE_TABLES,TABLE_RADIUS,CHAIR_OFFSET,STAFF_HOME,STAFF_ROLES,guestSeat,guestPath,pathLength,samplePath,guestWalkDuration} from './cafe-layout.js?v=0.8.1';
import {CAFE_MENU,guestPlace} from './cafe.js?v=0.8.1';
import {createCafeMeal,resetCafeMeal,setMealConsumed,animateCafeMeal,reachCafeHand} from './cafe-food.js?v=0.8.1';
...
import {guestServiceView,paintGuestBadge} from './cafe-service-view.js?v=0.8.1';
import {applyCafeGuestSignal,applyCafeWorkerPose,staffGesture} from './cafe-gestures.js?v=0.8.1';
