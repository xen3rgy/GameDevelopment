import {HOME_POINTS,HOMES,ITEMS,RECIPES,LOCATIONS,clamp} from './data.js?v=0.8.1';
import {clockMinutes,deadlineView} from './contracts.js?v=0.8.1';
import {heldLoad,fatigue} from './player-movement.js?v=0.8.1';
import {itemCount,insertItem,removeItem,inventoryWeight} from './inventory.js?v=0.8.1';
