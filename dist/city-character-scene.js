...
import {CITY_CHARACTER_FIXTURES,CITY_CHARACTER_OVERHEAD,LITTER_ZONES,HORIZON_ROADS} from './city-character-layout.js?v=0.8.1';
import {groundHeight} from './spatial.js?v=0.8.1';
import {createCitizen} from './art.js?v=0.8.1';
import {seatedStreetPose} from './pedestrian-scene.js?v=0.8.1';
