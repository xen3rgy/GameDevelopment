...
import {PROMENADE_FIXTURES} from './pedestrian-layout.js?v=0.7.2';
import {CITY_CHARACTER_FIXTURES} from './city-character-layout.js?v=0.7.2';
import {WORLD_BOUNDS,ROAD_X,DISTRICT_FIXTURES,exteriorContains} from './city-layout.js?v=0.7.2';
import {PARCEL_WALK_SPEED} from './player-movement.js?v=0.7.2';
import {BUILDINGS,LOCATIONS} from './data.js?v=0.7.2';
import {CityNavigation,routeLength} from './navigation.js?v=0.7.2';
import {STREETS} from './orientation.js?v=0.7.2';
