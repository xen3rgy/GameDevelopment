...
import {PROMENADE_FIXTURES} from './pedestrian-layout.js?v=0.8.0';
import {CITY_CHARACTER_FIXTURES} from './city-character-layout.js?v=0.8.0';
import {WORLD_BOUNDS,ROAD_X,DISTRICT_FIXTURES,exteriorContains} from './city-layout.js?v=0.8.0';
import {PARCEL_WALK_SPEED} from './player-movement.js?v=0.8.0';
import {BUILDINGS,LOCATIONS} from './data.js?v=0.8.0';
import {CityNavigation,routeLength} from './navigation.js?v=0.8.0';
import {STREETS} from './orientation.js?v=0.8.0';
